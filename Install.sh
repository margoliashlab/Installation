...
# addition on Oct 17 2017
sudo usermod -a -G audio $USER
sudo sed -i -e '55i@audio           -       rtprio          99\' /etc/security/limits.conf
###########
...
# Intan unzip
sudo unzip RHD2000interface_source_code_v1_5_2.zip -d RHD2000interface_source_code_v1_5_2
=======
# Intan USB drivers
...
>>>>>>> 4baa180603ccbaef3a29a094edb45060e0b1f944
...
# Addition Oct 17 2017
  # Make a script to run RHD
cd /home/$USER/Lab-Softwares/RHD2000interface_source_code_v1_5_2
sudo touch intan-interface.sh
sudo chmod 777 intan-interface.sh
echo cd /home/$USER/Lab-Softwares/RHD2000interface_source_code_v1_5_2/source >> intan-interface.sh
echo ./RHD2000interface >> intan-interface.sh

### Adding this intan-interface.sh permanently path is still pending
#######
...
sudo unzip Intan_controller_USB_drivers.zip -d USB\ interface\ drivers
sudo chmod -R 777 /home/$USER/Lab-Softwares/USB\ interface\ drivers
cd /home/$USER/Lab-Softwares/USB\ interface\ drivers/USB\ interface\ drivers/Linux
sudo cp -a 60-opalkelly.rules /etc/udev/rules.d/
cd /home/$USER/Lab-Softwares
